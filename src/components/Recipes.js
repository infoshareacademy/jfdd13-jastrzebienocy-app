// .toLowerCase()import React, {Component} from 'react';// import uuid from 'uuid';
...
const Recipes = [
  {
    ...
    recipeUrl:
      'https://myfridgefood.com/recipes/entree-chicken/amazing-roasted-chicken/',
    portions: 4
  },
  {
    ...
    weight: 1 + 'kg',
    imageUrl:
      'https://myfridgefood.com/recipes/entree-beef/amazing-mongolian-beef/'
  },
  {
  ...
  },
  {
    ...
    weight: 1.5 + 'kg',
    imageUrl:
      'https://myfridgefood.com/recipes/dessert/apple-pie-crescent-wraps/'
  },
  {
    ...
    weight: 1.5 + 'kg',
    imageUrl:
      'https://myfridgefood.com/recipes/salads-and-sides/baked-tomatoes-with-cheese/'
  },
  {
    ...
    weight: 500,
    imageUrl:
      'https://myfridgefood.com/recipes/salads-and-sides/baked-onion-rings/'
  },
  {
    ...
    weight: 1000,
    imageUrl:
      '	https://myfridgefood.com/recipes/apple-recipe-contest/cheesy-turkey-burgers-with-apples/'
  },
  {
